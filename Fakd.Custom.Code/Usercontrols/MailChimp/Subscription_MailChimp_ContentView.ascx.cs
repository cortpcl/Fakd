...
namespace Ontranet
{
    public partial class Subscription_MailChimp_ContentView : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                mailChimp_Lists();
                //  Subcribe_UnSubscribe();
                lblEmail.Text = umbraco.library.GetDictionaryItem("Label.Email") + "*";
                lblFirstName.Text = umbraco.library.GetDictionaryItem("Label.Firstname") + "*";
                lblLastName.Text = umbraco.library.GetDictionaryItem("Label.Lastname") + "*";
                lblListHeader.Text = umbraco.library.GetDictionaryItem("Label.Newslist.Header");
                btn.Text = umbraco.library.GetDictionaryItem("Submit");
                //lblMainHeader.Text = umbraco.library.GetDictionaryItem("Frontpage.Title.Nyhedsbrev");
                RequiredFieldValidator1.ErrorMessage = "<p>" + umbraco.library.GetDictionaryItem("Error.Email.Empty") + "</p>";
                RegularExpressionValidator1.ErrorMessage = "<p>" + umbraco.library.GetDictionaryItem("Error.Email.Invalid") + "</p";
                CheckBoxList1_Check.ErrorMessage = "<p>" + umbraco.library.GetDictionaryItem("Error.NoListSelected") + "</p>";
                RequiredFieldValidator2.ErrorMessage = "<p>" + umbraco.library.GetDictionaryItem("Error.FirstName.Empty") + "</p>";
                RequiredFieldValidator3.ErrorMessage = "<p>" + umbraco.library.GetDictionaryItem("Error.LastName.Empty") + "</p>"; 
            }
        }
